...
alert("В субботу вечером только вернулся из Москвы с кейса, успел сделать переключение цветов и размеров. То, что пропустил про EJS и остальное, буду стараться нагонять. Пока так");
